  ...
  apps: [
    {
      ...
      env: {
        ...
        OBSERVABILITY_REST_API_PORT: '9103',
        AGENT_LOGS_ENABLED: 'true',
        UI_STREAMING: 'true',
        AGENT_API_PORT: '9093',
        AGENT_API_URL: 'http://127.0.0.1:9093/agent',
        SIMPLE_UI_PORT: '4003',
        ...
        // Discord streaming timeout (default 20s is too short for GPT-4)
        DISCORD_STREAM_TIMEOUT: '60',
      },
    ...
    // Alternative: run via cargo (slower but doesn't require pre-build)
    {
      ...
      env: {
        ...
        OBSERVABILITY_REST_API_ENABLED: 'true',
        OBSERVABILITY_REST_API_HOST: '127.0.0.1',
        OBSERVABILITY_REST_API_PORT: '9104',
        AGENT_LOGS_ENABLED: 'true',
        UI_STREAMING: 'true',
        AGENT_API_PORT: '9094',
        SIMPLE_UI_PORT: '4004',
